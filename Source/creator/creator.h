 ...
 * JSON Related Keys
 */
constexpr auto __LLRX_OUTPUT__ =
    "output";  /// Output directory where llrx files will be saved;
constexpr auto __LLRX_FILE_NAMES__ =
    "files";  /// Array of midi file names that will be converted into LLRX files;
...
class Creator {
 public:
  ...
  /**
   * Using the json config file, this function will generate all the llrx files. Each llrx
   * file will also be validated in the validate function
   */
 ...
 private:
   ...
   */
  EntityVector createEntities(flatbuffers::FlatBufferBuilder& builder,
  ...
  /**
   * Validates that the llrx file created and contains the same amount of entities as the
   * midi file did
   */
